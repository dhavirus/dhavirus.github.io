...
**Project:** Diary & Tracker
**Generated:** 2026-09-22 20:27:10
...
> Swapped from the auto-generated default (warm brown + indigo, too muted) to the
> "Amber + Blue" option from `--domain color`, chosen by the user for its multi-hue
> saturation and nutrition/food-tracker fit.
...
| Card Foreground | `#78350F` | `--color-card-foreground` |
| Muted | `#F1F2EF` | `--color-muted` |
| Muted Foreground | `#475569` | `--color-muted-foreground` |
| Border | `#FDE68A` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#78350F` | `--color-ring` |

**Color Notes:** Energetic amber + booking blue. Ring changed from the source
palette's `#000000` to `--color-foreground` (`#78350F`) — a pure-black focus ring
reads as a foreign, un-themed color against this warm palette and a 3px hairline
of pure black looks harsher than intended; the foreground brown keeps 3:1+ contrast
on every surface (bg/card/primary/secondary) while matching the palette — contrast
numbers confirmed in Step 5's accessibility pass.

### Typography

> Swapped from the auto-generated default (Baloo 2 + Comic Neue, reads as a kids'/
> education app) to "Playful Creative" from `--domain typography`, chosen by the
> user for a lively-but-adult feel appropriate to a daily diary + tracker.
